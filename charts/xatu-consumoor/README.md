...
Xatu data consumer that pulls events from Kafka and inserts them into downstream sources like Clickhouse.
...
| autoscaling | object | `{"enabled":false,"maxReplicas":10,"minReplicas":3,"targetCPUUtilizationPercentage":80,"targetMemoryUtilizationPercentage":null}` | Autoscaling configuration |
| autoscaling.enabled | bool | `false` | If true, a HorizontalPodAutoscaler is created |
| autoscaling.maxReplicas | int | `10` | Maximum number of replicas |
| autoscaling.minReplicas | int | `3` | Minimum number of replicas |
